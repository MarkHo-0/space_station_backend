...
usersController.search = async function (req, res){
    ...
    searchData.pagaination = pagaination.create(req.query.page, searchData.pageCount, req.query);
    searchData[`setion_$(section)`] = true;
    searchData.displayUserSearch = true;
    await WebGL2RenderingContext(req, res, searchData);
