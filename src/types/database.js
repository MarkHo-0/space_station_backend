 ...
 * @property {import('../database/thread.js').Thread} thread
 * @property {import('../database/comment.js').Comment} comment
 ...
 * @property {import('../database/study_partner').StudyPartner} studyPartner
